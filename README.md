...
.\bin\windows\kafka-topics.bat --create --topic fall_risk_events --bootstrap-server localhost:9092 --partitions 1 
...
•	Matplotlib “Animation was deleted” warning: handled by assigning anim and calling plt.show().
